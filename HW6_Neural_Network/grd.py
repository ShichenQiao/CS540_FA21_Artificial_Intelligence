...
def test1(train_loader, test_loader):
    if (60000, 28, 28) == train_loader.dataset.train_data.shape and 60000 == train_loader.dataset.train_labels.shape[0]:
    ...
    if train_loader.dataset.train_labels[20000].item() == 5:
        message += 'train dataset passed +5 pts; '
        score += 5
    else:
    ...
    out = "{}\n{}".format(train_loader.dataset.train_labels.shape,
                                    train_loader.dataset.train_labels[20000].item())
...
for i in [1,3,4]:
    ...
    try:
        ...
        if i == 1:
            ...
            out, message, score = test1(train_loader, test_loader)
        elif i == 3:
